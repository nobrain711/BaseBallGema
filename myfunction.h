#pragma once
#include "structure.h"							//구조체 관련 헤더파일
...
void ranking(int);								// 랭킹 관련 출력 조회
void ballboard(score*);							// ball 카운트 출력
void strikeboard(score*);						// strike 카운트 출력
void outboard(score*);							// out 카운트 출력
void linesdraw(int);							// 안내문 테두리 출력
